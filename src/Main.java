...
public class Main {
    public static void main(String[] args) {
      ...
      /*  System.out.println(toFormattedBinary(Integer.MIN));
        System.out.println(toFormattedBinary(-2));
        System.out.println(toFormattedBinary(2));*/
        System.out.println(toFormattedBinary(Integer.MIN_VALUE));
        System.out.println(toFormattedBinary(1<<10));
    }
